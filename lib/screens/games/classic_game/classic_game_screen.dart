...
// Widgets spécifiques (Assure-toi que les imports sont corrects)
import 'widgets/text_input_widget.dart';
import 'widgets/drawing_widget.dart';
import 'widgets/wheel_widget.dart';

class ClassicGameScreen extends StatelessWidget {
  // Ajout d'un titre optionnel pour différencier les modes dans l'UI
  final String? gameTitle;

  const ClassicGameScreen({super.key, this.gameTitle});

  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final title = gameTitle ?? l10n.classicModeTitle;
            ...
            if (gameProvider.currentDeck == null) {
              return Center(
                child: Column(
                  ...
                  children: [
                    Text(l10n.noDeckSelected),
                    const SizedBox(height: 16),
                    ElevatedButton(
                      onPressed: () => Navigator.pop(context),
                      child: Text(l10n.selectDeck),
                    )
                  ],
                ),
              );
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              // Nom du Deck + Indicateur de mode (optionnel)
                              FittedBox(
                                  ...
                                  children: [
                                    ...
                                    if (gameProvider.isReverseMode)
                                      Container(
                                        ...
                                        child: const Text(
                                          "REVERSE", // À localiser si tu veux
                              ...
                              if (gameProvider.isCompleted)
                                ...
                                // Choix du widget d'input dynamique
  ...
  // ... _buildProgressBar est inchangé ...
  ...
  Widget _buildWordDisplay(BuildContext context, GameProvider gameProvider, bool isSmallScreen) {
            ...
            child: Column(
              children: [
                FittedBox(
                  fit: BoxFit.scaleDown,
                  child: Text(
                    // MODIFICATION ICI : Utilisation du getter dynamique
    ...
    // ... _buildCompletedCard est inchangé ...
    ...
    // ... _showRemainingWordsBottomSheet est inchangé ...
